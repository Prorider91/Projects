...
/*   Updated: 2019/01/10 18:20:58 by ffahey           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static char	*oct_to_str(char *buf, size_t size,
		unsigned long long n, unsigned flags)
{
	buf[0] = 0;
	buf[1] = 0;
	buf[--size] = '\0';
